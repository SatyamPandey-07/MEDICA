...
export const InsightPreviewWidget: React.FC<WidgetProps> = ({ instanceId, title, lastUpdated }) => {
  ...
  return (
    <>
      <WidgetHeader id={instanceId} icon={Compass} color="text-emerald-400" title={title} lastUpdated={lastUpdated}>
      ...
      <div className="flex-1 overflow-y-auto space-y-3 pr-1 min-h-0">
        <div className="p-3 rounded-xl bg-zinc-950/50 border border-white/5 shrink-0">
        ...
        {!isExpertMode ? (
          <>
            <div className="p-3 rounded-xl bg-zinc-950/30 border border-white/5 shrink-0">
          ...
          <>
            ...
            <div className="p-3 rounded-xl bg-zinc-950/50 border border-red-500/10 shrink-0">
            ...
            {p.abstract && (
              <div className="p-3 rounded-xl bg-zinc-950/20 border border-white/5 shrink-0">
